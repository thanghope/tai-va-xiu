...
export default function App() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "fixed inset-0 z-0 pointer-events-none", children: _jsx("div", { className: "w-full h-full bg-gradient-to-r from-[#021218] via-[#05202a] to-[#02121a] opacity-95" }) }), _jsx("div", { className: "w-full max-w-full md:max-w-7xl p-4 md:p-6", children: _jsxs("div", { className: "w-full max-w-full min-h-[78vh] bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.04)] rounded-3xl p-4\n  grid grid-cols-1 md:grid-cols-12 gap-4\n  overflow-hidden h-auto md:h-[78vh]", children: [_jsxs("div", { className: "col-span-1 md:col-span-8 flex flex-col gap-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { className: "text-xs text-slate-300", children: "S\u1ED0 D\u01AF" }), _jsxs("div", { className: "text-2xl font-bold text-amber-300", children: [fmt(balance), " \u20AB"] })] }), _jsx("div", { className: "text-right text-xs text-slate-400 max-w-[360px]" })] }), _jsxs("div", { className: "flex-1 bg-[linear-gradient(180deg,#06202b,rgba(255,255,255,0.01))] rounded-2xl p-6 flex items-center justify-center relative", children: [_jsxs("div", { className: "w-full flex items-center justify-center", children: [_jsxs("div", { className: "relative w-full max-w-full sm:max-w-[640px] h-[220px] sm:h-[320px] flex items-center justify-center", children: [_jsx("div", { className: "absolute -top-8 left-1/2 -translate-x-1/2 z-20 min-h-[42px]", children: bowlOpen && (_jsx("div", { className: `px-4 py-2 rounded-full text-xl font-bold ${lastResult === "tai" ? "text-emerald-300" : "text-rose-300"}`, children: `${lastResult?.toUpperCase() || ""} – ${sumDisplay}` })) }), _jsx(motion.div, { className: "flex gap-6 z-10", animate: rolling ? { rotate: [0, 360] } : { rotate: 0 }, transition: { duration: rolling ? 0.9 : 0.6, repeat: rolling ? Infinity : 0 }, children: lastDice.map((d, i) => (_jsx("div", { className: "flex items-center justify-center", children: _jsx(DiceSVG, { value: d }) }, i))) })] }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: _jsx(AnimatePresence, { children: !bowlOpen && (_jsx(motion.div, { ref: bowlRef, drag: waitingToOpen ? "x" : false, dragConstraints: { left: 0, right: 800 }, dragElastic: 0.2, onDragEnd: handleDragEnd, initial: { x: 0, y: -8, scale: 1 }, animate: waitingToOpen ? { x: 0 } : { x: 0 }, exit: { x: "140%" }, transition: { duration: 0.45, ease: "easeInOut" }, className: "pointer-events-auto z-30 w-[150%] h-[260px] rounded-full flex items-center justify-center", children: _jsx("div", { className: "absolute inset-0 pointer-events-auto z-30 rounded-full flex items-center justify-center", style: {
                                                                ...
                                                                }, children: _jsx("div", { className: "text-slate-300 text-sm select-none bg-black/40 px-3 py-1 rounded", children: rolling ? "Đang lắc..." : waitingToOpen ? "Kéo để mở bát →" : "Úp bát" }) }, Date.now()) }, "bowl")) }) }), _jsxs("div", { className: "flex items-center gap-2 ml-4", children: [_jsx("input", { type: "number", min: 1, value: betAmount, onChange: (e) => setBetAmount(Number(e.target.value)), className: "w-28 px-3 py-2 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.04)]" }), _jsx("div", { className: "flex gap-2", children: quickBets.map((b) => (_jsx("button", { onClick: () => setBetAmount(b), className: "px-3 py-2 rounded-lg bg-[rgba(255,255,255,0.01)] border", children: b }, b))) })] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("button", { onClick: startRoll, disabled: rolling || waitingToOpen, className: "px-5 py-3 rounded-2xl font-bold bg-amber-400 text-black shadow disabled:opacity-60", children: rolling ? "Đang lắc..." : "Lắc xúc xắc" }), _jsx("button", { onClick: openBowl, disabled: !waitingToOpen, className: "px-5 py-3 rounded-2xl font-bold bg-emerald-500 text-black shadow disabled:opacity-50", children: "M\u1EDF b\u00E1t" })] })] })] }), _jsxs("div", { className: "col-span-1 md:col-span-4 flex flex-col gap-4", children: [_jsx("div", { className: "rounded-2xl p-4 bg-[rgba(255,255,255,0.02)] border flex flex-col gap-3", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { className: "text-xs text-slate-400", children: "Nh\u00E0 c\u00E1i \u0111\u1EBFn t\u1EEB Ch\u00E2u \u00C1" }), _jsx("div", { className: "font-mono text-sm text-slate-200 break-words", children: clientSeed })] }), _jsx("div", { children: _jsx("button", { onClick: () => {
                                                        // LOG ĐỂ DEBUG (bạn có thể xóa khi đã ok)
                                                        console.log("Open Setting clicked");
                                                        setShowSettings(true);
                                                        setSettingPw("");
                                                        setSettingUnlocked(false);
                                                    }, className: "px-3 py-2 rounded-lg border bg-[rgba(255,255,255,0.01)]", children: "\u2699\uFE0F Setting" }) })] }) }), _jsxs("div", { className: "rounded-2xl p-4 flex-1 flex flex-col history-thin-bg", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsxs("div", { className: "font-semibold", children: ["L\u1ECBch s\u1EED (", history.length, ")"] }), _jsx("button", { onClick: () => {
                                                        if (confirm("Xóa lịch sử?"))
                                                            setHistory([]);
                                                    }, className: "text-xs px-2 py-1 rounded border bg-[rgba(255,255,255,0.01)]", children: "X\u00F3a" })] }), _jsxs("div", { className: "flex-1 overflow-auto max-h-[38vh] space-y-2 text-sm", children: [history.length === 0 && (_jsx("div", { className: "text-slate-400", children: "Ch\u01B0a c\u00F3 v\u00E1n n\u00E0o." })), history.map((h, idx) => (_jsxs("div", { className: "flex items-center justify-between bg-[rgba(255,255,255,0.01)] p-2 rounded", children: [_jsxs("div", { children: [_jsx("div", { className: "font-mono text-xs text-slate-300", children: new Date(h.time).toLocaleString() }), _jsxs("div", { className: "text-sm text-slate-100", children: [h.dice.join(" · "), " \u2192 ", h.result?.toUpperCase() || ""] }), " "] }), _jsx("div", { className: `text-sm font-semibold ${h.win ? "text-emerald-300" : "text-rose-400"}`, children: h.win
                                                                ? `+${fmt(Math.round(h.bet * payoutMultiplier))}`
                                                                : `-${fmt(h.bet)}` })] }, idx))), " "] })] }), _jsxs("div", { className: "rounded-2xl p-4 bg-[rgba(255,255,255,0.02)] border text-xs text-slate-400", children: [_jsx("div", { children: "Ch\u00FA \u00FD:" }), _jsxs("ul", { className: "list-disc pl-4 mt-2", children: [_jsxs("li", { children: ["Win tr\u1EA3: c\u01B0\u1EE3c \u00D7 ", payoutMultiplier.toFixed(2), " (nh\u00E0 c\u00E1i gi\u1EEF 2%)."] }), _jsx("li", { children: "X\u1EC9u(4-10) T\u00E0i(11-17)." })] })] })] })] }) }), _jsx(SettingsModal, { show: showSettings, settingPw: settingPw, setSettingPw: setSettingPw, tryUnlockSettings: tryUnlockSettings, settingUnlocked: settingUnlocked, setSettingUnlocked: setSettingUnlocked, setShowSettings: setShowSettings, depositValue: depositValue, setDepositValue: setDepositValue, doDeposit: doDeposit, doReset: doReset })] }));
}
